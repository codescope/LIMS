        ...
        <div class="container" style="margin-top: 90px;margin-bottom: 200px;">
            ...
            <div class="row ">
                <div class="col receipt_box">
                    ...
                    <a class="btn btn-primary" href="receipt_content.php?sample_id=<?php echo $sample['sample_id']; ?>" target="_blank">View Receipt</a>
                    <a class="btn btn-primary" href="sample_sample_receipt.php?sample_id=<?php echo $sample['sample_id']; ?>" target="_blank">Print Receipt</a>
                </div>
            </div>
