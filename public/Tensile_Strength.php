    ...
    <fieldset class="form-group mb-0">
        ...
        <div class="form-group row mb-0">
            <div class="form-group col-md-6">
                ...
                <div class="input-group">
                    <input class="form-control" type="text" id="mean_strength_wrap" placeholder="Enter Tensile Strength wrap">
        ...
        <div class="form-group row mb-0">
         ...
         <div class="form-group row mb-0">
            <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  <input class="form-control" type="text" id="mean_strength_weft" placeholder="Enter Tensile Strength weft">
                  <span class="input-group-addon">
                    <select id="mean_strength_unit">
                        <option>CN</option>
                        <option selected>N</option>
