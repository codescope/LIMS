...
//  validate_max_lengths_for_integers($fields_with_max_values);
    ...
    if (empty($errors)) {
        ...
        elseif ($test_standard=="ASTM D5034"){
            $test_conditions = "Specimen was tested as directed in test method ASTM D5034, Tested on LLOYD LRxPlus CRE type machine, Gage Length=75mm, Max. Obtainable force= 5KN, Jaw faces 25mmx100mm, Pneumatic Jaws with Rubber Gisps.";
        }
        else{
            $test_conditions ="";
        }
        ...
        $query  = "INSERT INTO tensile_strength (";
        ...
        if ($result && mysqli_affected_rows($connection) == 1) {
                ...
                redirect_to("view_sample_detail.php?sample_id=099610935517&test_name=tensile_test");
            }
            else{
...
<head>
  ...
  <title>Tensile Strength Testing Form</title>
</head>
<body>
...
<form action="Tensile_Strength.php" method="post">
  ...
  <fieldset class="form-group mb-0">
   ...
   <!-- <div class="form-group row mb-0"> 
    ...
    <fieldset class="form-group mb-0">
        ...
        <option value="ISO 13934-1" data-foo="NOTE: Speciman Size (200mm x 50 mm), Rate of Extension (20mm/min), Pretension (2N), Condtion:" >ISO 13934-1 (Strip Method)</option>
        <option value="ISO 13934-2" data-foo= "NOTE: Speciman Size (100mm x 100 mm), Rate of Extension (50mm/min), Condtion: ">ISO 13934-2 (Grab Method)</option>
        
        <option value="ASTM D5034" data-foo= "NOTE: Specimen was tested as directed in test method ASTM D5034, Tested on LLOYD LRxPlus CRE type machine, Gage Length=75mm, Max. Obtainable force= 5KN, Jaw faces 25mmx100mm, Pneumatic Jaws with Rubber Gisps, Condtion: ">ASTM D5034 (Grab Test)</option>
        
        <option value="ASTM D5035">ASTM D5035 (Strip Test)</option>
        </select>
        </div>
    ...
    <fieldset class="form-group mb-0">
        ...
        <div class="form-group row mb-0">
            <div class="form-group col-md-6">
                ...
                <div class="input-group">
                    <input class="form-control" type="text" id="mean_strength_wrap" name="mean_strength_wrap" placeholder="Enter Tensile Strength wrap" required>
        ...
        <div class="form-group row mb-0">
         ...
         <div class="form-group row mb-0">
            <div class="form-group col-md-6">
                ...
                <div class="input-group">
                  <input class="form-control" type="text" id="mean_strength_weft" name="mean_strength_weft" placeholder="Enter Tensile Strength weft" required>
                  <span class="input-group-addon">
