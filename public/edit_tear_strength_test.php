    ...
    <form action="edit_tear_strength_test.php?sample_id=<?php echo $sample['sample_id']; ?>" method="post">
        ...
        <fieldset class="form-group mb-0">
            ...
            <div class="form-group row mb-0">
                ...
                <div class="form-group col-6">
                    ...
                    <input class="form-control" type="text" id="sample_type" name="sample_type" placeholder="Enter Sample Type" <?php echo $sample['sample_type']; ?>" readonly>
                </div>
            </div>
            <!--<div class="form-group row mb-0">
                <div class="form-group col-6">
        ...
        <fieldset class="form-group mb-0">
            ...
            <div class="form-group row mb-0">
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="text" id="mean_percentage_elongation_weft" name="mean_percentage_elongation_weft" placeholder="Enter Mean Percentage Elongation weft" value="<?php echo $sample['mean_percent_elongation_weft']; ?>" required>
                </div><!-- form-group -->
                <div class="form-group col-md-4">
        ...
        <div class="row">
            <div class="col-1 offset-md-10">
                <button class="btn btn-primary" type="submit" onclick="location.href='view_sample_detail.php?sample_id=<?php echo $sample['sample_id'];?>&test_name=tear_test';" name="cancel">Cancel</button>
            </div>
            <div class="col-1">
