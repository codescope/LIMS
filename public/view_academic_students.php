...
?>
    ...
    <article>
        <h2>Select the option to filter the academic customers</h2>
        <marquee>This list contains both the record of academic customers/students</marquee>
        <div id="first_block">
            <form id="first_form" action="view_academic_students.php" method="post">
                <p>
                    ...
                    <select id="uni_sel" name="type" required>
                        <option value="academic" selected>Commercial</option>
